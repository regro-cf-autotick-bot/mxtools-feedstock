...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mxtools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14848&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mxtools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mxtools` can be installed with:

```
conda install mxtools
```

It is possible to list all of the versions of `mxtools` available on your platform with:
